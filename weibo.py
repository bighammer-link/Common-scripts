...
# 这里是你要签到的超话的id，每个超话的不一样，多个的话请用英文逗号隔开，例如‘[AA’,‘BB’]，进入到超话界面，地址栏中的地址的p/和/super_index之间的这一串
ids = ['']
...
for person_id in ids:
    ...
    try:
        ...
        if num ==len(ids):
          if SCKEY !='':
            requests.post("https://sctapi.ftqq.com/{}.send?title={}&desp={}".format(SCKEY, "微博超话签到", content))    
    except:
